...
import com.clinic.service.JwtFactoryService;
import com.clinic.utility.Configurator;
...
public class JwtFactoryServiceImpl implements JwtFactoryService{
	...
	@Override
	public JwtModel generateJWT(LoginEntity loginCredentials, String transactionId, RsaJsonWebKey senderJwk) {
		String jwt = "";
	...
	@Override
	public JwtModel generateRefreshJWT(LoginEntity loginCredentialsEntity, String transactionId, RsaJsonWebKey senderJwk) {
		String jwt = "";
		JwtModel jwtReqInstance = null;
		try {
