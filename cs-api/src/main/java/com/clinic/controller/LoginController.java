...
public class LoginController {
	...
	@PostMapping(value = "/l3/forgetPasswd")
	public ResponseEntity<LoginResponse> forgotpass(@RequestBody LoginRequest loginRequest) {

		LoginResponse loginResponse = new LoginResponse();

		loginResponse = loginServiceImpl.forgotPassword(loginRequest);

		return new ResponseEntity<LoginResponse>(loginResponse, HttpStatus.OK);
	}
	
	@DeleteMapping(value = "/l4/deleteUser")
	public ResponseEntity<LoginResponse> deleteUser(@RequestBody LoginRequest loginRequest){

		LoginResponse loginResponse = new LoginResponse();

		loginResponse = loginServiceImpl.deleteUser(loginRequest);
